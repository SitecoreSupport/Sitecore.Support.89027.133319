(function(scForm, scBrowser, $$) {
  ...
  window.Sitecore.Wfm.PopupMenu = new function() {
	...
	this.showFieldsPopup = function(event, controlid, height, width, args) {
      /* Obsolete */
      window.Sitecore.Forms.PopupMenu.args = args;
      ...
      showFieldsPopupExt(evt, node, evt.clientX - 180, evt.clientY);
    };
	
	    function showFieldsPopupExt(event, data, clientX, clientY) {
    ...
    /* Obsolete */
    window.Sitecore.Forms = window.Sitecore.Forms || {};
    window.Sitecore.Forms.PopupMenu = self;
    window.Sitecore.Forms.PopupMenu.args = null;
    window.Sitecore.Forms.PopupMenu.showPopupExt = showPopupExt;
  };
